from conf import supported_species
...
class UploadForm(FlaskForm):
    gtf_file = FileField('Gtf file',validators=[DataRequired()])
    specie_selection = SelectField(supported_species,validators=[DataRequired()])
